...
Fill in the following function skeletons - descriptions are provided in the PDF, and
briefly in the docstring (the triple quote thing at the top of each function)
...
if __name__ == "__main__":
    ...
    names = ["law", "roscoe", "kim", "langchung", "yan", "berg"]
    assert duck_duck_goose(names) == ["law", "yan"]
